...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: 'Inter-Bold', color: colors.text },
  error: {
  ...
  label: { fontSize: 13, fontFamily: 'Inter-Medium', color: colors.textSecondary, marginBottom: 6 },
  input: {
    backgroundColor: colors.surface, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12,
    fontSize: 15, fontFamily: 'Inter-Regular', color: colors.text, borderWidth: 1, borderColor: colors.border,
  },
  row: { flexDirection: 'row', gap: 12 },
  addButton: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  addText: { fontSize: 14, fontFamily: 'Inter-Medium', color: colors.primary },
  itemCard: {
    backgroundColor: colors.surface, borderRadius: 12, padding: 16, marginBottom: 12,
    borderWidth: 1, borderColor: colors.border,
  },
  itemHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  itemNumber: { fontSize: 13, fontFamily: 'Inter-SemiBold', color: colors.textSecondary },
  ...
  categoryChipText: { fontSize: 12, fontFamily: 'Inter-Medium', color: colors.textSecondary },
  ...
  saveButtonText: { color: colors.textInverse, fontSize: 16, fontFamily: 'Inter-SemiBold' },
});
